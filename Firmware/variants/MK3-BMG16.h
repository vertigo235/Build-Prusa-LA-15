...
// Printer name
#define CUSTOM_MENDEL_NAME "Prusa i3 MK3BMG16"
...
#define DEFAULT_MAX_FEEDRATE                {200, 200, 12, 35}       // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {100, 100, 12, 35}       // (mm/sec)   max feedrate (M203), silent mode
...
#define FILAMENTCHANGE_RFEED       (2100 / 60) // retract feedrate
#define FILAMENTCHANGE_EXFEED      (120 / 60)  // priming feedrate
